...
Если HTTPS завершается на reverse proxy, установите `APP_URL=https://ваш-домен`, обновите OIDC callback-адреса и включите `TRUST_PROXY_HEADERS=true`. Не включайте эту настройку при прямом доступе к Waitress.
